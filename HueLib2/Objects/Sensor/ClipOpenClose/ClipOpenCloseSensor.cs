...
namespace HueLib2.Objects.Sensor.ClipOpenClose
{
    [HueType("sensors")]
    class ClipOpenCloseSensor : ISensor
    {
        ...
        public ClipOpenCloseSensorConfig config { get; set; }
        [DataMember, ExpandableObject, Category("State"), Description("State of the sensor"), CreateOnly]
        public ClipOpenCloseSensorState state { get; set; }
