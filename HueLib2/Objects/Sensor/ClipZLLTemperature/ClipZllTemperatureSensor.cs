...
namespace HueLib2.Objects.Sensor.ClipZLLTemperature
{
    [HueType("sensors")]
    public class ClipZllTemperatureSensor : ISensor
    {
        ...
        public TemperatureSensorConfig config { get; set; }
        [DataMember, ExpandableObject, Category("State"), Description("State of the sensor"), CreateOnly]
        public TemperatureSensorState state { get; set; }
