...
namespace HueLib2.Objects.Sensor.ClipGenericFlag
{
    [HueType("sensors")]
    public class ClipGenericFlagSensor : ISensor
    {
        ...
        public ClipGenericFlagSensorConfig config { get; set; }
        [DataMember, ExpandableObject, Category("State"), Description("State of the sensor"), CreateOnly]
        public ClipGenericFlagSensorState state { get; set; }
