...
{
    [HueType("sensors")]
    public class HueTapSensor : ValidatableBindableBase, ISensor
    {
        ...
        private HueTapSensorConfig _config;
        ...
        public HueTapSensorConfig config
        {
            get => _config;
        ...
        {
            if(ssconfig.GetType() != typeof(HueTapSensorConfig)) return false;
            config = (HueTapSensorConfig)ssconfig;
            return true;
        }
