...
{
    [HueType("sensors")]
    public class ClipGenericFlagSensor : ValidatableBindableBase, ISensor
    {
        ...
        private ClipGenericFlagSensorConfig _config;
        private ClipGenericFlagSensorState _state;
        ...
        public ClipGenericFlagSensorConfig config
        {
            get => _config;
        ...
        public ClipGenericFlagSensorState state
        {
            get => _state;
        ...
        {
            if (ssconfig.GetType() != typeof(ClipGenericFlagSensorConfig)) return false;
            config = (ClipGenericFlagSensorConfig)ssconfig;
            return true;
        }

        public bool SetState(ISensorState sstate)
        {
            if (sstate.GetType() != typeof(ClipGenericFlagSensorState)) return false;
            state = (ClipGenericFlagSensorState)sstate;
            return true;
        }
