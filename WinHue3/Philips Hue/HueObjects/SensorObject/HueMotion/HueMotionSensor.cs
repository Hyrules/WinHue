...
{
    [HueType("sensors")]
    public class HueMotionSensor : ValidatableBindableBase, ISensor
    { 
        ...
        private HueMotionSensorConfig _config;
        ...
        public HueMotionSensorConfig config
        {
            get => _config;
        ...
        {
            if (ssconfig.GetType() != typeof(HueMotionSensorConfig)) return false;
            config = (HueMotionSensorConfig)ssconfig;
            return true;
        }
