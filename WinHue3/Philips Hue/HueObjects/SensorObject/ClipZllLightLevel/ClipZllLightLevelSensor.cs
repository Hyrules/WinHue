...
{
    [HueType("sensors")]
    public class ClipZllLightLevelSensor : ValidatableBindableBase, ISensor
    {
        ...
        private LightLevelConfig _config;
        private LightLevelState _state;
        ...
        public LightLevelConfig config
        {
            get => _config;
        ...
        {
            if (ssconfig.GetType() != typeof(LightLevelConfig)) return false;
            config = (LightLevelConfig)ssconfig;
            return true;
        }

        public bool SetState(ISensorState sstate)
        {
            if (sstate.GetType() != typeof(LightLevelState)) return false;
            state = (LightLevelState)sstate;
            return true;
        }
