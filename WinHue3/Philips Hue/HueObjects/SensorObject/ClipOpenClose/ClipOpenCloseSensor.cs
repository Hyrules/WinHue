...
{
    [HueType("sensors")]
    public class ClipOpenCloseSensor : ValidatableBindableBase, ISensor
    {
        ...
        private ClipOpenCloseSensorConfig _config;
        private ClipOpenCloseSensorState _state;
        ...
        public ClipOpenCloseSensorConfig config
        {
            get => _config;
        ...
        public ClipOpenCloseSensorState state
        {
            get => _state;
        ...
        {
            if (ssconfig.GetType() != typeof(ClipOpenCloseSensorConfig)) return false;
            config = (ClipOpenCloseSensorConfig)ssconfig;
            return true;
        }

        public bool SetState(ISensorState sstate)
        {
            if (sstate.GetType() != typeof(ClipOpenCloseSensorState)) return false;
            state = (ClipOpenCloseSensorState)sstate;
            return true;
        }
