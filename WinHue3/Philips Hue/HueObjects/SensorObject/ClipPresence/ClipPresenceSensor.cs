...
{
    [HueType("sensors")]
    public class ClipPresenceSensor : ValidatableBindableBase, ISensor
    {
        ...
        private ClipPresenceSensorConfig _config;
        private PresenceSensorState _state;
        ...
        public ClipPresenceSensorConfig config
        {
            get => _config;
        ...
        {
            if (ssconfig.GetType() != typeof(ClipPresenceSensorConfig)) return false;
            config = (ClipPresenceSensorConfig)ssconfig;
            return true;
        }

        public bool SetState(ISensorState sstate)
        {
            if (sstate.GetType() != typeof(PresenceSensorState)) return false;
            state = (PresenceSensorState)sstate;
            return true;
        }
