...
{
    [HueType("sensors")]
    public class ClipHumiditySensor : ValidatableBindableBase, ISensor
    {
        ...
        private ClipHumiditySensorConfig _config;
        private ClipHumiditySensorState _state;
        ...
        public ClipHumiditySensorConfig config
        {
            get => _config;
        ...
        public ClipHumiditySensorState state
        {
            get => _state;
        ...
        {
            if (ssconfig.GetType() != typeof(ClipHumiditySensorConfig)) return false;
            config = (ClipHumiditySensorConfig)ssconfig;
            return true;
        }

        public bool SetState(ISensorState sstate)
        {
            if (sstate.GetType() != typeof(ClipHumiditySensorState)) return false;
            state = (ClipHumiditySensorState)sstate;
            return true;
        }
