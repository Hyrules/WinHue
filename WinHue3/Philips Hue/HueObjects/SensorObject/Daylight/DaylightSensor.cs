...
{
    [HueType("sensors")]
    public class DaylightSensor : ValidatableBindableBase, ISensor
    {
        ...
        private DaylightSensorConfig _config;
        ...
        public DaylightSensorConfig config
        {
            get => _config;
        ...
        public DaylightSensorState state
        {
            get => _state;
        ...
        {
            if (ssconfig.GetType() != typeof(DaylightSensorConfig)) return false;
            config = (DaylightSensorConfig)ssconfig;
            return true;
        }

        public bool SetState(ISensorState sstate)
        {
            if (sstate.GetType() != typeof(DaylightSensorState)) return false;
            state = (DaylightSensorState)sstate;
            return true;
        }
