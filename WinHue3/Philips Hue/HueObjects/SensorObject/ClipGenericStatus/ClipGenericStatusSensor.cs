...
{
    [HueType("sensors")]
    public class ClipGenericStatusSensor : ValidatableBindableBase, ISensor
    {
        ...
        private ClipGenericStatusSensorConfig _config;
        private ClipGenericStatusSensorState _state;
        ...
        public ClipGenericStatusSensorConfig config
        {
            get => _config;
        ...
        public ClipGenericStatusSensorState state
        {
            get => _state;
        ...
        {
            if (ssconfig.GetType() != typeof(ClipGenericStatusSensorConfig)) return false;
            config = (ClipGenericStatusSensorConfig)ssconfig;
            return true;
        }

        public bool SetState(ISensorState sstate)
        {
            if (sstate.GetType() != typeof(ClipGenericStatusSensorState)) return false;
            state = (ClipGenericStatusSensorState)sstate;
            return true;
        }
