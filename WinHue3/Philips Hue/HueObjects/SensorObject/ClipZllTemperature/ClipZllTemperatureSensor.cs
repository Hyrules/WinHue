...
{
    [HueType("sensors")]
    public class ClipZllTemperatureSensor : ValidatableBindableBase, ISensor
    {
        ...
        private TemperatureSensorState _state;
        ...
        public TemperatureSensorConfig config
        {
            get => _config;
        ...
        public TemperatureSensorState state
        {
            get => _state;
        ...
        {
            if (ssconfig.GetType() != typeof(TemperatureSensorConfig)) return false;
            config = (TemperatureSensorConfig)ssconfig;
            return true;
        }

        public bool SetState(ISensorState sstate)
        {
            if (sstate.GetType() != typeof(TemperatureSensorState)) return false;
            state = (TemperatureSensorState)sstate;
            return true;
        }
