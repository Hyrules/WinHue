...
namespace WinHue3
{
     ...
     /*   public static string HexFromState(State state)
        {
            ...
            if (state.on == false || state.bri <= 5) //Off or low brightness
                return "000000";
      ...
      /*  private static string HexFromXy(double xNumber, double yNumber)
		...
		*****************************************************************************************/
        ...
        public static CGPoint CalculateXY(System.Windows.Media.Color color, string model)
        {
    ...
    /*    public static string HexFromState(State state, string model)
        ...
        public static System.Windows.Media.Color ColorFromXY(CGPoint xy, string model)
        {
            List<CGPoint> colorPoints = ColorPointsForModel(model);
